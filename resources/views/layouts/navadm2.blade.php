    ...
    <img src="/img/LOGO 1.png" alt="" width="160px" class="d-inline-block align-text-top pe-3 ps-2 mb-1" />
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mb-5 mb-lg-0 listmenu">
                ...
                <li class="nav-item ">
                    <a class="nav-link d-grid gap-2 d-flex justify-content-center menu"  aria-current="page" href="{{ route('laporan') }}">Laporan Pelamar</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link d-grid gap-2 d-flex justify-content-center menu" aria-current="page" href="{{ route('lowongan.index') }}">Iklan Lowongan</a>
                </li>
            </ul>
            <ul class="navbar-nav">
